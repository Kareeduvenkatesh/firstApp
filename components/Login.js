...
export default function Login({ switchToRegister, switchToUsersList }) {
  return (
    <View style={styles.container}>
      <View style={styles.centerContent}>
       ...
       <TextInput placeholder="Password" placeholderTextColor="white" secureTextEntry={true} style={styles.input} />
        ...
        <TouchableOpacity>
          <Text style={styles.login} onPress={switchToUsersList}>Login</Text>
        </TouchableOpacity>
        <Text style={styles.create} onPress={switchToRegister} >Create a new account</Text>
      </View>
    </View>
  );
}
